...
import (
	...
	typedscalingv1alpha1 "github.com/kzscaler/kzscaler/pkg/client/clientset/versioned/typed/scaling/v1alpha1"
	...
	if untyped == nil {
		if injection.GetConfig(ctx) == nil {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/kzscaler/kzscaler/pkg/client/clientset/versioned.Interface from context. This context is not the application context (which is typically given to constructors via sharedmain).")
		} else {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/kzscaler/kzscaler/pkg/client/clientset/versioned.Interface from context.")
		}
	}
...
func (w *wrapClient) ScalingV1alpha1() typedscalingv1alpha1.ScalingV1alpha1Interface {
	return &wrapScalingV1alpha1{
		dyn: w.dyn,
	}
}

type wrapScalingV1alpha1 struct {
	dyn dynamic.Interface
}

func (w *wrapScalingV1alpha1) RESTClient() rest.Interface {
