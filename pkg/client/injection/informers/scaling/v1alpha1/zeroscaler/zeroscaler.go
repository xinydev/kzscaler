...
func Get(ctx context.Context) v1alpha1.ZeroScalerInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kzscaler/kzscaler/pkg/client/informers/externalversions/scaling/v1alpha1.ZeroScalerInformer from context.")
	}
