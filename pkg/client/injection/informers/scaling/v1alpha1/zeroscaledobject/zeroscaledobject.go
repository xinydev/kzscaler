...
import (
	...
	apisscalingv1alpha1 "github.com/kzscaler/kzscaler/pkg/apis/scaling/v1alpha1"
	versioned "github.com/kzscaler/kzscaler/pkg/client/clientset/versioned"
	v1alpha1 "github.com/kzscaler/kzscaler/pkg/client/informers/externalversions/scaling/v1alpha1"
	client "github.com/kzscaler/kzscaler/pkg/client/injection/client"
	factory "github.com/kzscaler/kzscaler/pkg/client/injection/informers/factory"
...
func Get(ctx context.Context) v1alpha1.ZeroScaledObjectInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kzscaler/kzscaler/pkg/client/informers/externalversions/scaling/v1alpha1.ZeroScaledObjectInformer from context.")
	}
