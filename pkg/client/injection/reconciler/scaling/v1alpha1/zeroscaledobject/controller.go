...
import (
	...
	versionedscheme "github.com/kzscaler/kzscaler/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "zeroscaledobject-controller"
	defaultFinalizerName       = "zeroscaledobjects.scaling.xiny.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	zeroscaledobjectInformer := zeroscaledobject.Get(ctx)

	lister := zeroscaledobjectInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "scaling.xiny.dev.ZeroScaledObject"),
	)
